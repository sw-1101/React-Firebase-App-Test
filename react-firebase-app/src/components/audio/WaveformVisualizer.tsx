...
export const WaveformVisualizer: React.FC<WaveformVisualizerProps> = ({
  ...
  const [displayData, setDisplayData] = useState<number[]>(new Array(barCount).fill(0));
  ...
  return (
    ...
    >
      <canvas
        ...
        aria-label={`音声波形: ${isRecording ? '録音中' : '停止中'}, 録音時間 ${Math.floor(duration / 60)}分${duration % 60}秒`}
      />
    </Box>
  );
};
