...
interface UploadedFile {
  file: File;
  type: 'audio' | 'video' | 'image' | 'pdf' | 'excel' | 'markdown' | 'other';
  preview?: string;
}
...
const MultimodalInput: React.FC<MultimodalInputProps> = ({ onSubmit, loading = false }) => {
  ...
  const playUploadedAudio = (file: File) => {
